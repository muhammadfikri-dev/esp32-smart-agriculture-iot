...
const char* MQTT_CLIENT_ID      = "Laksanasoft-Agri-Node01";
const char* TOPIC_TELEMETRY     = "laksanasoft/agriculture/node_01/telemetry";
const char* TOPIC_STATUS        = "laksanasoft/agriculture/node_01/status";
const char* TOPIC_COMMAND       = "laksanasoft/agriculture/node_01/control";
const char* TOPIC_CONFIG        = "laksanasoft/agriculture/node_01/config";
...
void updateOLEDDisplay() {
    ...
    display.printf("LAKSANASOFT AGRI [Z1/Z2]");
...
void setup() {
    Serial.begin(115200);
    Serial.println("\n=======================================================");
    Serial.println("  Laksanasoft ESP32 Enterprise Smart Agriculture Node   ");
    Serial.println("=======================================================");
    ...
    display.setTextSize(1);
    display.setTextColor(SSD1306_WHITE);
    display.println("Laksanasoft Agri Boot...");
    display.display();
    ...
    if (WiFi.status() == WL_CONNECTED) {
        ...
        ArduinoOTA.setHostname("esp32-agri-laksanasoft");
        ArduinoOTA.begin();
    } else {
